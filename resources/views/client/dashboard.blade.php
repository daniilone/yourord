...
@section('title', 'Клиент - Дашборд - YourOrd')
@section('content')
    <div class="max-w-7xl mx-auto">
        <h1 class="text-3xl font-bold mb-6 text-gray-800">Добро пожаловать, {{ $client->name ?? $client->email }}</h1>
        <h2 class="text-2xl font-semibold mb-4 text-gray-700">Ваши записи</h2>
