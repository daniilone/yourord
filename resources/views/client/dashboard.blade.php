...
<head>
    ...
    <title>Клиент - Дашборд - YourOrd</title>
...
<div class="min-h-screen flex">
    ...
    <div class="flex-1 p-4 sm:pl-64">
        <div class="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-bold text-gray-800 mb-6 animate-fade-in">Добро пожаловать, {{ $client->name ?? $client->email }}</h2>
            ...
            <div class="mt-8 flex flex-col sm:flex-row gap-4">
                <a href="{{ route('client.projects') }}"
                   class="bg-accent text-white px-6 py-3 rounded-lg hover:bg-green-600 transition duration-300 text-center font-medium">Найти проект</a>
            </div>
        </div>
    </div>
</div>
