...
@section('content')
    <div class="p-6">
        <h1 class="text-2xl font-bold text-primary mb-6">Ваши проекты</h1>
        ...
        <a href="{{ route('specialist.projects.create') }}" class="bg-primary text-white px-4 py-2 rounded mb-6 inline-block">Создать проект</a>
